...
- [ ] **Fase 3 — offline / PWA: BOZZA spec+piano scritte (2026-07-05), da revisionare con Lorenzo** — spec `docs/superpowers/specs/2026-07-05-dflight-fase3-offline-pwa.md` (scope: manifest+icone, SW precache shell, update col consenso, runtime cache stile mappa, UX offline; decisioni aperte A–D: cache tile CARTO, plugin vs SW manuale, bottone installa, icone) + piano `docs/superpowers/plans/2026-07-05-dflight-fase3-offline-pwa.md` (8 task a livello di contratto, codice da dettagliare post-approvazione; Task 2 = spike vite-plugin-pwa ↔ rolldown-vite).
